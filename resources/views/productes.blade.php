            ...
            <section class="bg-white rounded-lg shadow p-6">
                ...
                @if ($mineral)
                    ...
                    <div id="mineral-container" class="flex flex-wrap gap-6">
                        ...
                        <div class="flex-1 max-w-sm">
                            <img id="mineral-foto" src="{{ asset($mineral->foto ?? 'img/placeholder.jpg') }}" alt="{{ __('Foto del mineral') }}" class="w-full rounded-md shadow">
                        </div>
                        <!-- Informació del Mineral -->
                        <div class="flex-1 flex flex-col justify-between">
                            <div>
                                <h3 id="mineral-nom" class="text-2xl font-bold mb-4 text-gray-800">{{ $mineral->nom }}</h3>
                                <p id="mineral-preu" class="text-lg text-gray-700 mb-4">{{ __("Preu:") }} {{ $mineral->preu }} €</p>
                ...
                @else
                    ...
                    <div id="no-mineral" class="py-40 text-center text-gray-700">
                        <p class="text-lg">{{ __("Selecciona algun mineral per veure més informació.") }}</p>
                    </div>
                @endif
            </section>
        </div>
